"""
Django settings for takajo project.
...
SECRET_KEY = '-rdg88w*imlo@ac^w*@b_43l+(#otr8awd8o&f=o478a6*8&*n'
...
WSGI_APPLICATION = 'takajo.wsgi.application'
